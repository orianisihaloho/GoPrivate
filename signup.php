    ...
    <div class="col-sm-12"><center>
      <form action="signup_process.php" method="post">
        <table>
          <tr>
            <td>Fullname</td>
            <td><input type="text" id="fullname" class="form-control" name="fullname" placeholder="Fullname" required></td>
          </tr>
          <tr>
            <td>Email</td>
          ...
          <tr>
            <td>Username</td>
            <td><input type="text" id="username" class="form-control" name="username" placeholder="username" required></td>
          </tr>
          <tr>
            <td>Password</td>
            <td><input type="password" id="password" class="form-control" name="password" placeholder="password" required></td>
          </tr>
        </table><br>
        <button type="submit" class="btn btn- btn-md" name="signup">SignUp</button>
      </form>
      <br>Anda telah memiliki akun? <a href="login.php"> Masuk Akun </a>
    </center>
  </div>
</div>
